...
const Auth = () => {
  ...
  }, [authLoading, navigate, profile?.onboarding_completed, user]);
  ...
  return (
    <div className="min-h-screen flex bg-background">
      {/* Left panel */}
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-primary/10 via-background to-primary/5 p-12">
        <div className="max-w-md space-y-6 animate-in-up">
          <div className="flex items-center gap-3">
            <div className="h-12 w-12 rounded-xl bg-primary flex items-center justify-center">
              <GraduationCap className="h-7 w-7 text-primary-foreground" />
            </div>
            <h1 className="text-3xl font-bold text-foreground">KIIT Connect</h1>
          </div>
          <p className="text-xl text-muted-foreground leading-relaxed">
            The exclusive social platform for KIIT University students. Connect, share, and grow with your peers.
          </p>
          <div className="flex flex-wrap gap-2">
            {["#placements", "#hackathon", "#coding", "#hostel"].map((tag) => (
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md space-y-8 animate-in-up">
          <div className="lg:hidden flex items-center gap-3 justify-center mb-4">
            ...
            <h1 className="text-2xl font-bold text-foreground">KIIT Connect</h1>
          </div>
          ...
          <p className="text-xs text-center text-muted-foreground leading-relaxed">
            ...
            Gmail accounts are not allowed. Google sign-in works as a single continue flow for both existing and new
            KIIT accounts.
          </p>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="roll.no@kiit.ac.in"
                  value={email}
